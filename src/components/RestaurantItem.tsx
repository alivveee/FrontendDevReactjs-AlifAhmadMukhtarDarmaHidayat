  ...
  return (
    <div className="flex flex-col gap-4 mb-6">
      ...
      <div className="flex flex-col gap-1">
        <h2 className="text-lg md:text-xl text-gray-900">{restaurant.name}</h2>
        <div className="ratings flex">
          <StarRating rating={restaurant.rating} />
        </div>
        <div className="flex flex-col md:flex-row justify-between text-sm uppercase text-gray-600">
      ...
      <button
        ...
        className="bg-blue-950 text-sm md:text-base text-white px-4 py-2"
      >
        LEARN MORE
      </button>
    </div>
